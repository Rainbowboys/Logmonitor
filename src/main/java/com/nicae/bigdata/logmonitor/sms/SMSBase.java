package com.nicae.bigdata.logmonitor.sms;
...
public class SMSBase {
    ...
    private static final String USER_ID = "xiaozhang";
    private static final String PASSWORD = "xiaozhang";
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(sendSms("15632695088", "日志监控平台-系统1发生异常，需要处理！"));
